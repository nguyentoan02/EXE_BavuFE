...
const ServiceDetailDaily = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Modal Form */}
            <ModalFormDaily isOpen={isModalOpen} onClose={handleCloseModal} />
        </div>
    );
};

export default ServiceDetailDaily;
